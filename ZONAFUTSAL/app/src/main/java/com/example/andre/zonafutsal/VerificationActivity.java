...
public class VerificationActivity extends AppCompatActivity implements
    ...
    private ViewGroup mKeterangan;
    private ViewGroup mKeterangan2;
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (uiState == STATE_CODE_SENT) {
            ...
            mKeterangan.setVisibility(View.GONE);
            mKeterangan2.setVisibility(View.VISIBLE);
            ...
            mKeterangan.setVisibility(View.VISIBLE);
            mKeterangan2.setVisibility(View.GONE);
        }
